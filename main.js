...
document.addEventListener("DOMContentLoaded", () => {
  ...
  experienceSection.innerHTML = `
    ...
    <div class="bg-gray-800/30 p-6 rounded-lg space-y-6 text-gray-300">
      <p>
        DevOps engineer with hands-on experience in AWS, Terraform, Docker, Kubernetes and CI/CD pipelines.
        Skilled in infrastructure automation, container orchestration, and monitoring solutions.
        Passionate about improving deployment workflows and ensuring secure, scalable environments.
      </p>
      <p>
        Projects: <a href="https://github.com/Bogdanj22" target="_blank" class="text-blue-400 underline">GitHub Portfolio</a>
      </p>
